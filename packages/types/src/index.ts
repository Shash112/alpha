// ==========================================
// 1. GLOBAL ERROR CODES & COMMON INTERFACES
// ==========================================
...
export interface PublicCardProjectionDto {
  ...
  sections: CardSectionPayload[]; // Stripped of PRIVATE and HIDDEN fields
  workspaceBranding?: {
    logoUrl?: string;
    brandColor?: string;
